...
class _EstablishmentsScreenState extends ConsumerState<EstablishmentsScreen> {
  ...
  Future<void> _showAddDialog(
    ...
    final totalParkingSpotsController = TextEditingController(); // NEW
          ...
          ElevatedButton(
            onPressed: () async {
              final est = Establishment(
                ...
                totalParkingSpots: int.tryParse(totalParkingSpotsController.text.trim()) ?? 0, // NEW
  ...
  Future<void> _showEditDialog(
    ...
    final totalParkingSpotsController = TextEditingController(text: e.totalParkingSpots.toString()); // NEW
          ...
          ElevatedButton(
            onPressed: () async {
              final updated = e.copyWith(
                name: nameController.text.trim(),
                address: addressController.text.trim(),
                totalParkingSpots: int.tryParse(totalParkingSpotsController.text.trim()) ?? e.totalParkingSpots, // NEW
                organizationType: orgType,
              );
